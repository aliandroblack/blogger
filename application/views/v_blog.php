		...
		<div class="col-md-9">
			...
			foreach($artikel as $a){
				...
				<div class="col-md-12 box-artikel">
					<a class="col-md-3" href="<?php echo base_url() ?>blogger/single/<?php echo $a->id_artikel ?>">
						<img class="col-md-12" src="<?php echo base_url().'images/'.$a->foto ?>" alt="<?php echo $a->judul ?>">
					</a>
					<div class="col-md-9">
						<a href="<?php echo base_url() ?>blogger/single/<?php echo $a->id_artikel ?>" class="title-artikel"><?php echo $a->judul ?></a>
						<?php echo substr($a->isi_artikel,0,250)." .." ?>
						<br/>
						<a href="<?php echo base_url() ?>blogger/single/<?php echo $a->id_artikel ?>" class="btn btn-sm btn-success pull-right">Read more</a>
					</div>
				</div>
				<?php } ?>
			</div>
